...
const MapSiteStyleRouter_1 = __importDefault(require("../../models/Style/MapSiteStyleRouter"));
...
router.get('/api/mapsitestyle', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let mapSiteComponentStyle = yield MapSiteStyleRouter_1.default.findOne();
        if (!mapSiteComponentStyle) {
            mapSiteComponentStyle = new MapSiteStyleRouter_1.default(defaultMapSiteComponentStyle);
...
router.post('/api/mapsitestyle', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const mapSiteComponentStyle = new MapSiteStyleRouter_1.default(req.body);
    try {
...
router.put('/api/mapsitestyle/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const mapSiteComponentStyle = yield MapSiteStyleRouter_1.default.findById(req.params.id);
        if (!mapSiteComponentStyle) {
